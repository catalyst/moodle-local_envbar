...
$string['checkrefresh'] = 'Check for overdue refreshes';
...
$string['debuggingoff'] = 'Debug: Off';
$string['debuggingon'] = 'Debug: On';
$string['debugtogglelinkoff'] = 'Turn Off';
$string['debugtogglelinkon'] = 'Turn On';
$string['emaildiverted'] = 'DIVERTED';
$string['emailheading'] = 'Email prefix';
$string['emailnoemailever'] = 'DISABLED';
$string['emailon'] = 'On';
...
$string['enablemenuprod'] = 'Enable menu swapper for prod';
$string['enablemenuprod_desc'] = 'This setting controls if the environment swapper menu is added to the user menu or not in production.';
...
$string['eventenvbardeleted'] = 'Envbar environment deleted';
$string['eventenvbarupdated'] = 'Envbar environment created or updated';
...
$string['gotolastrefresh'] = 'Go to last refresh page';
...
$string['showemail'] = 'Show email status';
$string['showemail_desc'] = 'This setting controls if the envbar shows wether email is on, disabled or diverted.';
...
$string['wwwroot_invalid'] = 'The wwwroot provided was missing or not a valid URL.';
