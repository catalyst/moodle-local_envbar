...
$string['nextrefresh'] = 'Next refresh';
$string['nextrefresh_desc'] = 'The time of the next refresh, expressed in natural language. See <a target=_blank href="https://www.php.net/manual/en/datetime.formats.php#datetime.formats.relative">PHP relative dates</a>';
