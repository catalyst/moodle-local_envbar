...
if ($hassiteconfig) {
    ...
    $presentation->add(new admin_setting_configcheckbox('local_envbar/showdebugconfiglink',
            get_string('showdebugconfiglink', 'local_envbar', null, true),
            get_string('showdebugconfiglink_desc', 'local_envbar', null, true),
            true));
