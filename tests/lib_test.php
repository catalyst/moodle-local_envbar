...
class local_envbar_lib_test extends advanced_testcase {
    ...
    public function test_get_toggled_debug_config() {
        ...
        $this->assertEquals(DEBUG_NORMAL, envbarlib::get_toggled_debug_config(1));
        $this->assertEquals(DEBUG_NORMAL, envbarlib::get_toggled_debug_config('DEVELOPER'));
        $this->assertEquals(DEBUG_NORMAL, envbarlib::get_toggled_debug_config($data));
        $this->assertEquals(DEBUG_NORMAL, envbarlib::get_toggled_debug_config($array));
    ...
    public function test_get_toggled_debug_display() {
        ...
        $data = new StdClass();
        $array = array('DEBUG_DEVELOPER', 'DEBUG_NORMAL');
        $this->assertEquals(0, envbarlib::get_toggled_debug_display(1));
        $this->assertEquals(0, envbarlib::get_toggled_debug_display('DEVELOPER'));
        $this->assertEquals(0, envbarlib::get_toggled_debug_display($data));
        $this->assertEquals(0, envbarlib::get_toggled_debug_display($array));
    ...
    public function test_get_debugging_status_string() {
        ...
        $data = new StdClass();
        $array = array('DEBUG_DEVELOPER', 'DEBUG_NORMAL');
        $this->assertEquals('Debugging Off', envbarlib::get_debugging_status_string(1));
        $this->assertEquals('Debugging Off', envbarlib::get_debugging_status_string('DEVELOPER'));
        $this->assertEquals('Debugging Off', envbarlib::get_debugging_status_string($data));
        $this->assertEquals('Debugging Off', envbarlib::get_debugging_status_string($array));
        $this->assertEquals('Debugging Off', envbarlib::get_debugging_status_string(DEBUG_NORMAL));
        $this->assertEquals('Debugging On', envbarlib::get_debugging_status_string(DEBUG_DEVELOPER));
    }
    ...
    public function test_set_debug_config() {
        ...
        $data = new StdClass();
        $array = array('DEBUG_DEVELOPER', 'DEBUG_NORMAL');
        $this->assertEquals(true, envbarlib::set_debug_config(100));
        $this->assertEquals(true, envbarlib::set_debug_config('DEVELOPER'));
        $this->assertEquals(true, envbarlib::set_debug_config($data));
        $this->assertEquals(true, envbarlib::set_debug_config($array));
        $this->assertEquals(true, envbarlib::set_debug_config(DEBUG_NORMAL));
        $this->assertEquals(true, envbarlib::set_debug_config(DEBUG_DEVELOPER));
    }
}
